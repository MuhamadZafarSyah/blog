    ...
    <main class="bg-gray-100 font-montserrat">
        ...
        <div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
                ...
                <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <defs>
                        ...
                        <linearGradient id="linear-gradient-11" x1="91" y1="95.76" x2="91" y2="112.53"
                            xlink:href="#linear-gradient-3" />
                        <linearGradient id="linear-gradient-12" x1="110.58" y1="95.76" x2="110.58"
                            y2="112.53" xlink:href="#linear-gradient-3" />
                        <linearGradient id="linear-gradient-13" x1="76.12" y1="131.17" x2="62.87"
                            y2="198.72" xlink:href="#linear-gradient-3" />
                    </defs>
                    <title>men</title>
            ...
            <div
                ...
                <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">Welcome to Zet|Blog</h1>
                <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900">Ceritakan cerita anda ke semua orang , dari pengalaman
                    pribadi hingga refleksi mendalam, di sini setiap cerita memiliki tempatnya sendiri. Jadilah bagian dari
                    platform di mana suara Anda didengar dan dihargai.</p>
                <a href="/login"
                    class="font-semibold text-lg bg-purple-600 hover:bg-blue-400 text-white py-3 px-12 rounded-full">Buat
                    Postingan</a>
            </div>
            <svg class="w-full absolute bottom-0 left-0" id="Capa_1" data-name="Capa 1"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 497.5 141.26">
                <title>skyline</title>
                ...
                <rect x="233.63" y="72.33" width="11.74" height="12.1" transform="translate(479 156.76) rotate(180)"
                    style="fill:#afaacf" />
                <polygon points="252.98 43.37 252.98 148.86 279.77 148.86 279.77 55.81 252.98 43.37"
                    style="fill:#d5daee" />
                ...
                <rect x="382.66" y="90.22" width="9" height="9.27" transform="translate(774.33 189.72) rotate(180)"
                    style="fill:#afaacf" />
                <polygon points="397.49 68.03 397.49 148.86 418.02 148.86 418.02 77.56 397.49 68.03"
                    style="fill:#d5daee" />
                ...
                <rect x="135.14" y="104.9" width="8.6" height="2.35" transform="translate(278.88 212.15) rotate(180)"
                    style="fill:#bebcdb" />
                <rect x="135.14" y="109.19" width="8.6" height="2.35"
                    transform="translate(278.88 220.73) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="113.48" width="8.6" height="2.35"
                    transform="translate(278.88 229.31) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="117.77" width="8.6" height="2.35"
                    transform="translate(278.88 237.89) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="122.06" width="8.6" height="2.35"
                    transform="translate(278.88 246.47) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="126.35" width="8.6" height="2.35"
                    transform="translate(278.88 255.05) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="130.64" width="8.6" height="2.35"
                    transform="translate(278.88 263.62) rotate(180)" style="fill:#bebcdb" />
                <rect x="135.14" y="134.93" width="8.6" height="2.35" transform="translate(278.88 272.2) rotate(180)"
                    style="fill:#bebcdb" />
                <rect x="135.14" y="139.22" width="8.6" height="2.35"
                    transform="translate(278.88 280.78) rotate(180)" style="fill:#bebcdb" />
                ...
                <rect x="318.36" y="104.9" width="8.6" height="2.35" transform="translate(645.32 212.15) rotate(180)"
                    style="fill:#bebcdb" />
                <rect x="318.36" y="109.19" width="8.6" height="2.35"
                    transform="translate(645.32 220.73) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="113.48" width="8.6" height="2.35"
                    transform="translate(645.32 229.31) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="117.77" width="8.6" height="2.35"
                    transform="translate(645.32 237.89) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="122.06" width="8.6" height="2.35"
                    transform="translate(645.32 246.47) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="126.35" width="8.6" height="2.35"
                    transform="translate(645.32 255.05) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="130.64" width="8.6" height="2.35"
                    transform="translate(645.32 263.62) rotate(180)" style="fill:#bebcdb" />
                <rect x="318.36" y="134.93" width="8.6" height="2.35" transform="translate(645.32 272.2) rotate(180)"
                    style="fill:#bebcdb" />
                <rect x="318.36" y="139.22" width="8.6" height="2.35"
                    transform="translate(645.32 280.78) rotate(180)" style="fill:#bebcdb" />
